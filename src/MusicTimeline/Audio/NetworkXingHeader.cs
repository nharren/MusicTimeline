...
namespace NathanHarrenstein.MusicTimeline.Audio
{
    ...
    /// </summary>
    public class NetworkXingHeader
    {
        [Flags]
        ...
        public static NetworkXingHeader LoadXingHeader(NetworkMp3Frame frame)
        {
            NetworkXingHeader xingHeader = new NetworkXingHeader();
        ...
        /// The MP3 frame
        /// </summary>
        public NetworkMp3Frame Mp3Frame
        {
            get { return frame; }
        }
