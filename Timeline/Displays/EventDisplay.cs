...
using NathanHarrenstein.Timeline.UI.Panels;
using System;
...
namespace NathanHarrenstein.Timeline
{
    ...
    {
        public static readonly DependencyProperty DatesProperty = DependencyProperty.Register("Dates", typeof(ExtendedDateTimeInterval), typeof(EventDisplay));
        ...
        public void Pan(Vector delta)
        {
            ...
            var eventPanel = (EventPanel)ItemsHost;
            eventPanel.ViewUpdated = true;
            eventPanel.VisibleCacheIndexes.Clear();
